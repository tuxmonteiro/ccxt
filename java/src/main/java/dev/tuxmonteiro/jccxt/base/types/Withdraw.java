...
public class Withdraw implements Serializable
{
    ...
    @JsonProperty("min")
    private Double min;
    private final static long serialVersionUID = 1885014397411917086L;
    ...
    public String toString() {
        ...
        sb.append(Withdraw.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("max");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Withdraw) == false) {
            return false;
        }
        Withdraw rhs = ((Withdraw) other);
