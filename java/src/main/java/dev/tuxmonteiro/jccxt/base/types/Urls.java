...
public class Urls implements Serializable
{
    ...
    @JsonProperty("doc")
    public Optional<List<String>> getDoc() {
    ...
    public boolean equals(Object other) {
        ...
        Urls rhs = ((Urls) other);
        return (((((((((this.fees == rhs.fees)||((this.fees!= null)&&this.fees.equals(rhs.fees)))&&((this.referral == rhs.referral)||((this.referral!= null)&&this.referral.equals(rhs.referral))))&&((this.test == rhs.test)||((this.test!= null)&&this.test.equals(rhs.test))))&&((this.www == rhs.www)||((this.www!= null)&&this.www.equals(rhs.www))))&&((this.doc == rhs.doc)||((this.doc!= null)&&this.doc.equals(rhs.doc))))&&((this.logo == rhs.logo)||((this.logo!= null)&&this.logo.equals(rhs.logo))))&&((this.api == rhs.api)||((this.api!= null)&&this.api.equals(rhs.api))))&&((this.apiManagement == rhs.apiManagement)||((this.apiManagement!= null)&&this.apiManagement.equals(rhs.apiManagement))));
    }
