...
public class MinMax implements Serializable
{
    ...
    public String toString() {
        ...
        sb.append(MinMax.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("max");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MinMax) == false) {
            return false;
        }
        MinMax rhs = ((MinMax) other);
